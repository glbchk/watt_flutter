...
class AddStationBankAccountDetailsPage extends StatefulWidget {
  // final VoidCallback onPress;

  const AddStationBankAccountDetailsPage({
    super.key,
    // required this.onPress,
  });

  @override
  State<AddStationBankAccountDetailsPage> createState() =>
      _AddStationBankAccountDetailsPageState();
}

class _AddStationBankAccountDetailsPageState
    extends State<AddStationBankAccountDetailsPage> {
